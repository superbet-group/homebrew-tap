cask "teleport-cli" do
  deprecate! date: "2026-03-04", because: "use teleport-cli formula instead: brew install superbet-group/tap/teleport-cli"
  disable!   date: "2026-06-01", because: "use teleport-cli formula instead: brew install superbet-group/tap/teleport-cli"
